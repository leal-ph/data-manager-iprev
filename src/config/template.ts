...
export const renewPassMailCodeTemplate =
  ...
  '                  <td class="content-cell">' +
  "                    <h1>Recuperação de Senha!</h1>" +
  "                    <p>Utilize o código abaixo para recuperar a sua senha de acesso ao portal Bocayuva Advogados! O código tem validade de 1 (uma) hora. Caso você não tenha solicitado a troca de senha, ignore este e-mail!</p>" +
  "                    <!-- Action -->" +
  '                    <table class="body-action" align="center" width="100%" cellpadding="0" cellspacing="0">' +
  "                      <tr>" +
  '                        <td align="center">' +
